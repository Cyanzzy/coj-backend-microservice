package com.cyan.springcloud.userservice.service.impl;
...
import com.cyan.springcloud.model.dto.user.UserQueryRequest;
import com.cyan.springcloud.model.entity.User;
import com.cyan.springcloud.model.enums.UserRoleEnum;
import com.cyan.springcloud.model.vo.LoginUserVO;
import com.cyan.springcloud.model.vo.UserVO;
import com.cyan.springcloud.userservice.mapper.UserMapper;
...
import static com.cyan.springcloud.common.constant.UserConstant.USER_LOGIN_STATE;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
     ...
     * 盐值，混淆密码
     */
    private static final String SALT = "cyan";
    ...
    public LoginUserVO userLogin(String userAccount, String userPassword, HttpServletRequest request) {
        ...
        // 用户不存在
        if (user == null) {
            log.info("questionservice login failed, userAccount cannot match userPassword");
